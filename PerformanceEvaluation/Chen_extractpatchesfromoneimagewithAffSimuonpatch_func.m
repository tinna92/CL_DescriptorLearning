%in this file, extract features in one image, simulating different view and
...
for ii = 1:Num_originfeatures
    current_patch = reshape(descrs_origin(:,ii),63,63);
    [aff_img] =  Chen_fullyaff_images_generate(current_patch,a,b,n);
