...
for iii=1:Num_Epoches
    ...
    for batch_ground =1:Num_train_batches 
        ...
        [cost,grad_I]= Chen_DeepDescTrainingCost_WithNonlinear_sigmoid_withoutregulari(theta,shrinkRate,x_l,x_r,y,0,10); % test with nonlinear here
        ...
        [cost_Adjust,grad]= Chen_DeepDescTrainingCost_WithNonlinear_sigmoid_withoutregulari(theta,shrinkRate,x_l_Adjust,x_r_Adjust,y_adjust,0,10); % test with nonlinear here
...
%         theta = theta - v_tplus1;  
        ...
        [cost_Adjust1,grad_theta_tplushalf]= Chen_DeepDescTrainingCost_WithNonlinear_sigmoid_withoutregulari(theta_tplusahalf,shrinkRate,x_l_Adjust,x_r_Adjust,y_adjust,0,10);
