...
for iii=1:Num_Epoches
    ...
    for batch_ground =1:Num_train_batches 
        ...
        [cost,grad]= Chen_DeepDescTrainingCost_WithNonlinear_RELU(theta,shrinkRate,x_l,x_r,y,1,10); % test with nonlinear here
...
%         theta = theta - v_tplus1;  
        ...
        [cost,grad_theta_tplushalf]= Chen_DeepDescTrainingCost_WithNonlinear_RELU(theta_tplusahalf,shrinkRate,x_l,x_r,y,1,10);
...
%     hold on;
    ...
    [valid_Eucl_dist]= Chen_DeepDescTest_WithNonlinear_RELU(theta,shrinkRate,test_x_l,test_x_r,valid_test_y,1,10);
...
[test_Eucl_dist]= Chen_DeepDescTest_WithNonlinear_RELU(theta,shrinkRate,test_x_l,test_x_r,test_y,0,10);
