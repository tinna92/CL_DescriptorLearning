...
function [resl,resr] = PatchDesc_DeepCnn_WithNonlinear_sigmoid_LRNNormalize_FN(x_l,x_r, w1, b1,w2,b2,w3,b3, dzdxl,dzdxr)
...
%     vl_nnsigmoid(x,dzdy);
    ...
    resr.x7 = vl_nnnormalize(resr.x6,[5 2 1.0000e-04 0.75]);
% end
...
if nargin > 8
    resl.dzdx7 = dzdxl ;
    resl.dzdx6 = vl_nnnormalize(resl.x6, [5 2 1.0000e-04 0.75],resl.dzdx7);
...
%     resr.dzdx6 = dzdxr ;
    resr.dzdx7 = dzdxr ;
    resr.dzdx6 = vl_nnnormalize(resr.x6, [5 2 1.0000e-04 0.75],resr.dzdx7);
