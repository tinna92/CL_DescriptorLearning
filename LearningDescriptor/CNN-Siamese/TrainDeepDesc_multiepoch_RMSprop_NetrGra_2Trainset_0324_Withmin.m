...
% -------------------------------------------------------------------------
Num_Epoches  = 80; % num of iterations( for each training sample)
...
for iii=1:Num_Epoches
    ...
    for batch_ground =1:Num_train_batches 
        ...
        [cost,grad]= Chen_DeepDescTrainingCost_WithNonlinear_sigmoid_LRNNormalize(theta,shrinkRate,x_l,x_r,y,1,10); % test with nonlinear here
        ...
        [cost_Adjust,grad]= Chen_DeepDescTrainingCost_WithNonlinear_sigmoid_LRNNormalize(theta,shrinkRate,x_l_Adjust,x_r_Adjust,y_adjust,1,10); % test with nonlinear here
...
%         nestrov gradient descent.
        ...
        [cost,grad_theta_tplushalf]= Chen_DeepDescTrainingCost_WithNonlinear_sigmoid_LRNNormalize(theta_tplusahalf,shrinkRate,x_l_Adjust,x_r_Adjust,y_adjust,1,10);
...
%     hold on;
    ...
    [valid_Eucl_dist]= Chen_DeepDescTest_WithNonlinear_sigmoid_LRNNormalize(theta,shrinkRate,test_x_l,test_x_r,valid_test_y,1,10);
...
% clear TPR FPR
save('learnedParamaters2403_30_batchsize_1000_train_om_liberty_Yosimate_validation.mat','theta');
save('Save_v_t_r_t_Loss_alpha_2403_50_batchsize_1000__liberty_Yosimate_validation.mat','r_t','v_t','Loss_Rec','alpha');