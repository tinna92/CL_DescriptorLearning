% this function test also the nonlinear function, which is followed 
...
% 10.06.2015 by Lin Chen
function [resl,resr] = PatchDesc_DeepCnn_WithNonlinear(x_l,x_r, w1, b1,w2,b2,w3,b3, dzdxl,dzdxr)
...
if nargin > 8
    ...
    resr.dzdx4 = vl_nnrelu(resr.x4, rho2,resr.dzdx4n);
