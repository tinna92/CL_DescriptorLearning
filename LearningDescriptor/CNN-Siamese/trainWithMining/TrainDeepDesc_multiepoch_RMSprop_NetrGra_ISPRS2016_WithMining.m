...
for iii=1:Num_Epoches
    ...
    for batch_ground =1:Num_train_batches 
        ...
        % mining here to decrease the size of training samples and use
        % efficient samples
        ...
        [cost_Adjust,grad]= Chen_DeepDescTrainingCost_WithNonlinear_sigmoid_LRNNormalize(theta,shrinkRate,x_l_Adjust,x_r_Adjust,y_adjust,0,10); % test with nonlinear here
...
%         theta = theta - v_tplus1;  
        ...
        [cost_Adjust1,grad_theta_tplushalf]= Chen_DeepDescTrainingCost_WithNonlinear_sigmoid_LRNNormalize(theta_tplusahalf,shrinkRate,x_l_Adjust,x_r_Adjust,y_adjust,0,10);
...
%     hold on;
    ...
    [valid_Eucl_dist]= Chen_DeepDescTrainingCost_WithNonlinear_sigmoid_LRNNormalize(theta,shrinkRate,test_x_l,test_x_r,valid_test_y,1,10);
