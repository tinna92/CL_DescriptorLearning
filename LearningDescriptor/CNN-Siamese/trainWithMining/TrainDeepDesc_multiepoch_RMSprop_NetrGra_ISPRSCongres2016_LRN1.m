...
%         theta = theta - v_tplus1;  
        ...
        [cost,grad_theta_tplushalf]= Chen_DeepDescTrainingCost_WithNonlinear_sigmoid_LRNNormalize(theta_tplusahalf,shrinkRate,x_l,x_r,y,3,10);
...
%     hold on;
    ...
    [valid_Eucl_dist]= Chen_DeepDescTrainingCost_WithNonlinear_sigmoid_LRNNormalize(theta,shrinkRate,test_x_l,test_x_r,valid_test_y,3,10);
...
% clear TPR FPR
% save('learnedParamaters0317_30_batchsize_1000_liberty_validation_3pull_10push.mat','theta');
% save('Save_v_t_r_t_Loss_alpha_0317_30_batchsize_1000__liberty_3pull_10push.mat','r_t','v_t','Loss_Rec','alpha');
