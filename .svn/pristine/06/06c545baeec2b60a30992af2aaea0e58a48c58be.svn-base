...
% clear TPR FPR
save('learnedParamaters2206_100_batchsize_1000_liberty_validation.mat','theta');
save('Save_v_t_r_t_Loss_alpha_2206_100_batchsize_1000__liberty.mat','r_t','v_t','Loss_Rec','alpha');
