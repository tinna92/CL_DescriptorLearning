...
current_F = estimateFundMatFromimagePoints(Current_selectedPoint_coord1,Current_selectedPoint_coord2); % calculate the fundmental matrix
Current_error = Chen_CalPointPair_FundmentalMatrix_error(current_F,img_coord1',img_coord2');
[mm,all_point_index] = find(Current_error<Fund_thershold);
inlinear_index = all_point_index;
All_selectedPoint_coord1 = img_coord1(1:3,all_point_index);
All_selectedPoint_coord2 = img_coord2(1:3,all_point_index);
F_matrix = estimateFundMatFromimagePoints(All_selectedPoint_coord1,All_selectedPoint_coord2); 
