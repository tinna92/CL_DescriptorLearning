...
% -------------------------------------------------------------------------
Num_Epoches  = 5; % num of iterations( for each training sample)
Size_batches = 512; % size of the batch
Num_batches = 300; % how many batches are used for training
...
%         theta = theta - v_tplus1;  
        ...
        [cost,grad_theta_tplushalf]= Chen_DeepDescTrainingCost(theta_tplusahalf,shrinkRate,x_l,x_r,y,3,15);
...
[test_Eucl_dist]= Chen_DeepDescTest(theta,shrinkRate,test_x_l,test_x_r,test_y,3,15);
...
% save('learnedParamaters0206_50.mat','theta');
