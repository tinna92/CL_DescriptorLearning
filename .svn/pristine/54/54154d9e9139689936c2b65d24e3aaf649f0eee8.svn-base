...
vl_roc(test_y', test_Eucl_dist(1:2*Size_testSamples)') ;
% clear TPR FPR
save('learnedParamaters2403_80_batchsize_1000_train_om_liberty_Yosimate_validation_withoutMining.mat','theta');
save('Save_v_t_r_t_Loss_alpha_2403_80_batchsize_1000__liberty_Yosimate_validation_withoutMining.mat','r_t','v_t','Loss_Rec','alpha');