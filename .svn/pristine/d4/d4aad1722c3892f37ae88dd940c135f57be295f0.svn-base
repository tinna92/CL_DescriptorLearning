% estimate essential matrix from identical image points and K matrix 
% [E,X,R] output essential matrix, camera center translation, and rotation matrix
% img1,img2 identical points in 2 images for fundemental matrix estimation 
% c,x0,y0,m,s : focal length, prinple point coord, Non-square ratio and
% non-ortho scale
function [E,X,R] = estimateEssenMatFromimagePoints(img1,img2,c,x0,y0,m,s)
