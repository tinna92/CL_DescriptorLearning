...
% clear TPR FPR
save('learnedParamaters1203_30_batchsize_1000_train_om_liberty_Yosimate_validation.mat','theta');
save('Save_v_t_r_t_Loss_alpha_1203_50_batchsize_1000__liberty_Yosimate_validation.mat','r_t','v_t','Loss_Rec','alpha');