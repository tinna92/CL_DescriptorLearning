...
load('learnedParamaters2711_17_batchsize_1000_yosemite.mat');
...
% clear TPR FPR
save('learnedParamaters2511_20_batchsize_1000_yosemite.mat','theta');
save('Save_v_t_r_t_Loss_alpha_2511_20_batchsize_1000__yosemite.mat','r_t','v_t','Loss_Rec','alpha');
