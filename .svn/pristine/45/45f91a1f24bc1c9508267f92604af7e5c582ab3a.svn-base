...
for iii=1:Num_Epoches
    ...
    for batch_ground =1:Num_train_batches 
        ...
        [cost,grad]= Chen_DeepDescTrainingCost_WithNonlinear_sigmoid_LRNNormalize(theta,shrinkRate,x_l,x_r,y,5,10); % test with nonlinear here
...
%         theta = theta - v_tplus1;  
        ...
        [cost,grad_theta_tplushalf]= Chen_DeepDescTrainingCost_WithNonlinear_sigmoid_LRNNormalize(theta_tplusahalf,shrinkRate,x_l,x_r,y,5,10);
...
%     hold on;
    ...
    [valid_Eucl_dist]= Chen_DeepDescTrainingCost_WithNonlinear_sigmoid_LRNNormalize(theta,shrinkRate,test_x_l,test_x_r,valid_test_y,5,10);
...
save('Save_v_t_r_t_Loss_alpha_0319_30_batchsize_1000__noterme.mat','r_t','v_t','Loss_Rec','alpha');
