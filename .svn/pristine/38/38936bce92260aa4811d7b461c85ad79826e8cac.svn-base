...
for iii=1:Num_Epoches
    ...
    for batch_ground =1:Num_train_batches 
        ...
        [cost,grad]= Chen_DeepDescTrainingCost_WithNonlinear_sigmoid_LRNN_TANH(theta,shrinkRate,x_l,x_r,y,3,10); % test with nonlinear here
...
%         theta = theta - v_tplus1;  
        ...
        [cost,grad_theta_tplushalf]= Chen_DeepDescTrainingCost_WithNonlinear_sigmoid_LRNN_TANH(theta_tplusahalf,shrinkRate,x_l,x_r,y,3,10);
...
%     hold on;
    ...
    [valid_Eucl_dist]= Chen_DeepDescTrainingCost_WithNonlinear_sigmoid_LRNN_TANH(theta,shrinkRate,test_x_l,test_x_r,valid_test_y,0,10);
...
test_y(1:Size_testSamples)=1;
test_y(Size_testSamples+1:2*Size_testSamples)=0;
[test_Eucl_dist]= Chen_DeepDescTest_WithNonlinear_sigmoid_LRNN_FN_TANH(theta,shrinkRate,test_x_l,test_x_r,test_y,0,10);
...
% clear TPR FPR
% save('learnedParamaters0316_30_batchsize_1000_liberty_validation.mat','theta');
% save('Save_v_t_r_t_Loss_alpha_0316_30_batchsize_1000__liberty.mat','r_t','v_t','Loss_Rec','alpha');
