...
Size_batches = 1000; % size of the batch
% Num_batches = 500; % how many batches are used for training
Num_train_batches = 225;
...
% clear TPR FPR
save('learnedParamaters0901_10_batchsize_1000_liberty_validation.mat','theta');
save('Save_v_t_r_t_Loss_alpha_0901_10_batchsize_1000__liberty.mat','r_t','v_t','Loss_Rec','alpha');
