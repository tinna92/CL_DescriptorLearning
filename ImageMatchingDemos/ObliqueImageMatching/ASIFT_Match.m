...
[frames_Aff1,descrs_Aff1,feature_index1] = Chen_ExtractedAffineimageFeatures2('E:\MultiPlatform Photogrammetry dataset\RELEASE_FOLDER_IMAGE_ORIENTATION\Photogrammetric_image_block\images\IGI-UM_Soest-City_GSD5cm-Nadir.jpgresize.pngcropped.jpg','Hessian','SIFT',3,sqrt(2),180);
[frames_Aff2,descrs_Aff2,feature_index2] = Chen_ExtractedAffineimageFeatures2('E:\MultiPlatform Photogrammetry dataset\RELEASE_FOLDER_IMAGE_ORIENTATION\Photogrammetric_image_block\images\IGI-UM_Soest-City_GSD7cm-ObliqueEast.jpgresize.pngcropped.jpg','Hessian','SIFT',3,sqrt(2),180);
...
% randm_selected = randperm();
Chen_show_matchresult(rgb2gray(imread('E:\MultiPlatform Photogrammetry dataset\RELEASE_FOLDER_IMAGE_ORIENTATION\Photogrammetric_image_block\images\IGI-UM_Soest-City_GSD5cm-Nadir.jpgresize.pngcropped.jpg')),...
    rgb2gray(imread('E:\MultiPlatform Photogrammetry dataset\RELEASE_FOLDER_IMAGE_ORIENTATION\Photogrammetric_image_block\images\IGI-UM_Soest-City_GSD7cm-ObliqueEast.jpgresize.pngcropped.jpg')),matches_Desc,frames_Aff1,frames_Aff2,0);
...
draw_epipolar_lines(F_matrix,rgb2gray(imread('E:\MultiPlatform Photogrammetry dataset\RELEASE_FOLDER_IMAGE_ORIENTATION\Photogrammetric_image_block\images\IGI-UM_Soest-City_GSD5cm-Nadir.jpgresize.pngcropped.jpg')),...
    rgb2gray(imread('E:\MultiPlatform Photogrammetry dataset\RELEASE_FOLDER_IMAGE_ORIENTATION\Photogrammetric_image_block\images\IGI-UM_Soest-City_GSD7cm-ObliqueEast.jpgresize.pngcropped.jpg')),correct_Match_coord1',correct_Match_coord2');
Chen_show_matchresult(rgb2gray(imread('E:\MultiPlatform Photogrammetry dataset\RELEASE_FOLDER_IMAGE_ORIENTATION\Photogrammetric_image_block\images\IGI-UM_Soest-City_GSD5cm-Nadir.jpgresize.pngcropped.jpg')),...
    rgb2gray(imread('E:\MultiPlatform Photogrammetry dataset\RELEASE_FOLDER_IMAGE_ORIENTATION\Photogrammetric_image_block\images\IGI-UM_Soest-City_GSD7cm-ObliqueEast.jpgresize.pngcropped.jpg')), matches_Desc(1:2,inlinear_index),frames_Aff1,frames_Aff2,0);
