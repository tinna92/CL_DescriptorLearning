...
img_path1 = 'data/013_015_163000060.tifresize.png';
img_path2 = 'data/013_017_163000058.tifresize.png';
...
frame_out1(:,check_index)
theta = frame_out1(4,check_index);
scale =  frame_out1(3,check_index);
figure(2);
imshow(rgb2gray(imread(img_path1)));
A = scale*[cos(theta),-sin(theta);sin(theta),cos(theta)];
frame_current = [frame_out1(1,check_index),frame_out1(2,check_index),A(:)'];
