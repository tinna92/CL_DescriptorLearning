...
Hessframse_left = Hessian_Detector.extractFeatures('E:\software\IPI\Data\graf\img1.ppm');
...
Hessframse_right = Hessian_Detector.extractFeatures('E:\software\IPI\Data\graf\img5.ppm');
...
Test_distance_sift = Min_distance_sift + 0.2*(Max_distance_sift-Min_distance_sift);
% [current_match_index,dis] = find(distance_match(:)<10);
